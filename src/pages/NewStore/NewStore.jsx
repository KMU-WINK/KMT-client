...
export default function NewStore() {
    ...
    const handleSaveClick = () => {
        ...
        axios.post('api/restaurants', dataToSend)
            .then((response) => {
                // 요청이 성공했을 때의 처리
                console.log('Location 정보가 성공적으로 전송되었습니다.', response.data);
                navigate("/Map");
    ...
    return (
        <P.Page>
            ...
            <N.StoreName1>
                <div>식당 이름: </div>
                <input onChange={(e) => setRestaurantName(e.target.value)} style={{marginLeft:"10px",height:"20px"}}></input>
            </N.StoreName1>
